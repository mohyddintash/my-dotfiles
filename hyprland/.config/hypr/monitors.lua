...
-- Laptop (LG Display, ~15") - scale 1.5 for comfortable text
hl.monitor({ output = "eDP-1", mode = "1920x1080@60", position = "0x0", scale = 1.5 })

-- Acer CB342CK 34" ultrawide - smooth 60fps, full ultrawide width
hl.monitor({ output = "HDMI-A-1", mode = "2560x1080@60", position = "auto-left", scale = 1.25 })
